...
There exists a debug build, DragonGame.exe file, that holds the latest build made with the project, which uses some parts of the engine and is easily playable.
